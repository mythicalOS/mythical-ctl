...
[this repository](https://github.com/mythicalOS/mythical-ctl/security/advisories/new)
...
**In scope:** source code in this organisation's repositories, published `mythical-ctl` release
artifacts, and the container images this CLI installs.
